...
var n,o,i=r.moduleCount,u=e.size/i,f=a;for(p&&e.radius>0&&e.radius<=.5&&(f=c),t.beginPath(),n=0;i>n;n+=1){
for(o=0;i>o;o+=1){
...
var n=e(t.text,t.ecLevel,t.minVersion,t.maxVersion,t.quiet);if(!n){
return null;
}var o=w(r).data("qrcode",n),a=o[0].getContext("2d");return i(n,a,t),l(n,a,t),o;
}function s(r){
var t=w("<canvas/>").attr("width",r.size).attr("height",r.size);return g(t,r);
}function h(r){
return w("<img/>").attr("src",s(r)[0].toDataURL("image/png"));
}function v(r){
var t=e(r.text,r.ecLevel,r.minVersion,r.maxVersion,r.quiet);if(!t){
return null;
}var n,o,i=r.size,a=r.background,u=Math.floor,f=t.moduleCount,c=u(i/f),l=u(.5*(i-c*f)),g={position:"relative",left:0,top:0,padding:0,margin:0,width:i,height:i},s={position:"absolute",padding:0,margin:0,width:c,height:c,"background-color":r.fill},h=w("<div/>").data("qrcode",t).css(g);for(a&&h.css("background-color",a),n=0;f>n;n+=1){
for(o=0;f>o;o+=1){
...
var l=e[c].dataCount,g=e[c].totalCount-l;o=Math.max(o,l),a=Math.max(a,g),u[c]=new Array(l);for(var s=0;s<u[c].length;s+=1){
u[c][s]=255&t.getBuffer()[s+n];
}n+=l;var h=i.getErrorCorrectPolynomial(g),v=r(u[c],h.getLength()-1),d=v.mod(h);f[c]=new Array(h.getLength()-1);for(var s=0;s<f[c].length;s+=1){
...
if(c.getLengthInBits()>=8*s){
break;
}if(c.put(o,8),c.getLengthInBits()>=8*s){
break;
}c.put(a,8);
}return C(c,n);
...
var a=e.read();if(-1==a){
break;
}var u=n(),f=n(),c=n(),l=String.fromCharCode(a<<8|u),g=f<<8|c;i[l]=g,o+=1;
}if(o!=t){
throw new Error(o+" != "+t);
}return i;
}(),n="?".charCodeAt(0);return function(r){
for(var t=new Array,o=0;o<r.length;o+=1){
var i=r.charCodeAt(o);if(128>i){
t.push(i);
}else{
...
switch(r){
case o.PATTERN000:return function(r,t){
return(r+t)%2==0;
...
if(t>=1&&10>t){
switch(r){
case e.MODE_NUMBER:return 10;case e.MODE_ALPHA_NUM:return 9;case e.MODE_8BIT_BYTE:return 8;case e.MODE_KANJI:return 8;default:throw new Error("mode:"+r);
}
}else if(27>t){
switch(r){
case e.MODE_NUMBER:return 12;case e.MODE_ALPHA_NUM:return 11;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 10;default:throw new Error("mode:"+r);
}
}else{
if(!(41>t)){
throw new Error("type:"+t);
}switch(r){
case e.MODE_NUMBER:return 14;case e.MODE_ALPHA_NUM:return 13;case e.MODE_8BIT_BYTE:return 16;case e.MODE_KANJI:return 12;default:throw new Error("mode:"+r);
}
}
...
switch(e){
case n.L:return r[4*(t-1)+0];case n.M:return r[4*(t-1)+1];case n.Q:return r[4*(t-1)+2];case n.H:return r[4*(t-1)+3];default:return void 0;
}
};return e.getRSBlocks=function(r,e){
var n=o(r,e);if("undefined"===typeof n){
...
var r=new Array,t=0,e={};return e.getBuffer=function(){
return r;
},e.getAt=function(t){
...
var n=e.MODE_8BIT_BYTE,o=t.stringToBytes(r),i={};return i.getMode=function(){
return n;
...
var r=new Array,t={};return t.writeByte=function(t){
r.push(255&t);
...
var e=r,n=t,o=new Array(r*t),i={};i.setPixel=function(r,t,n){
o[t*e+r]=n;
},i.write=function(r){
