...
function m(){
var b=c(i),a=c(h);d&&(h.length?d.reject(e,b,a):d.resolve(e));c.isFunction(f)&&f.call(g,e,b,a);
}function j(b,a){
...
0,o=c.isFunction(d.notify),e=g.find("img").add(g.filter("img")),k=[],i=[],h=[];c.isPlainObject(f)&&c.each(f,function(b,a){
if("callback"===b){
f=a;
}else if(d){
d[b](a);
...
var d=a.src,e=c.data(a,"imagesLoaded");if(e&&e.src===d){
j(a,e.isBroken);
